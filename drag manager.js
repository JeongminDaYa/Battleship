...
function makeDragNode(el, x, y)
{
	...
	*/
	...
	{
		if(currentDragNode.shipType == "5"){
			shipFiveY = currentDragNode.getBoundingClientRect().top;
			shipFiveX = currentDragNode.getBoundingClientRect().left;
		}
		if(currentDragNode.shipType == "4"){
			shipFourY = currentDragNode.getBoundingClientRect().top;
			shipFourX = currentDragNode.getBoundingClientRect().left;
		}
		if(currentDragNode.shipType == "3.1"){
			shipThreeOneY = currentDragNode.getBoundingClientRect().top;
			shipThreeOneX = currentDragNode.getBoundingClientRect().left;
		}
		if(currentDragNode.shipType == "3.2"){
			shipThreeTwoY = currentDragNode.getBoundingClientRect().top;
			shipThreeTwoX = currentDragNode.getBoundingClientRect().left;
		}
		if(currentDragNode.shipType == "2"){
			shipTwoY = currentDragNode.getBoundingClientRect().top;
			shipTwoX = currentDragNode.getBoundingClientRect().left;
		}
